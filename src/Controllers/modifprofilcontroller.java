...
loaddata();    }    
    ...
    private void modifier(ActionEvent event) {
         Utilisateur upuser = new Utilisateur(idu, txt_nom.getText(), txt_prenom.getText(), Integer.parseInt(txt_num.getText()), passe.getText(), txt_genre.getText(), txt_email.getText(),roles.getText(),img.getText());
                 ...
                 txt_prenom.setText(rs.getString("prenom"));
                  txt_email.setText(rs.getString("adress_email"));
                   txt_num.setText(String.valueOf(rs.getInt("num_tel")));
                    ...
                    roles.setText(rs.getString("roles"));
